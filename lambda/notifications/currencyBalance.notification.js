...
const notify = async (event, error) => {
  try {
    const message = {
      ...
      subject: `${process.env.ENVIRONMENT}: failed to create get currency balance from Telos`,
      text: `The blockchain-api has attempted to get the currency balance ${event} .\n\n` +
